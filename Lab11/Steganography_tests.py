...
class SteganographyTestSuite(unittest.TestCase, ImageAssertion):
    ...
    def test_PayloadWithImageInput(self):
        ...
        with self.subTest(key="Color Image 1, Level 9"):
            ...
            #print("Expected shape: " + str(expectedValue.shape))
            #print("Actual shape: " + str(actualValue.shape))

            #print("Difference: " + str(np.setdiff1d(actualValue, expectedValue)))

            writeFile("Expected.txt", str(expectedValue))
            writeFile("Actual.txt", str(actualValue))
