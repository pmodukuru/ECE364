...
class Consumer(QMainWindow, Ui_MainWindow):
    ...
    def InitObjects(self):
        ...
        self.slideCompression.valueChanged.connect(self.sliderChanged) #QUESTION: SHOULD THIS BE ON RELEASE OR AS YOU DRAG (valueChanged instead of sliderReleased?)
